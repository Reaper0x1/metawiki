# <img src="/authentik-icon.png" width="40" height="40" style="display:inline-block; vertical-align: middle; margin-right: 10px">Authentik <Badge type="tip" text="docker" style=" position: relative; float: right;" />
